...
Extra credits do not expire. They are valid for as long as Sigmund exists and uses the current system of fair use in combination with extra credit. When Sigmund stops its service, or stops using the current system of fair use in combination with extra credit, remaining extra credits will not be refunded.
